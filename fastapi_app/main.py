...
EXPOSE_PORT = os.environ.get(8000)
OTLP_GRPC_ENDPOINT = os.environ.get("http://10.10.120.79:4317")

TARGET_ONE_HOST = os.environ.get("app-b"s 
TARGET_TWO_HOST = os.environ.get("app-c")
